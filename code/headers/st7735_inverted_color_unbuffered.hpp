...
namespace r2d2::display {
    ...
    /**
     * Class st7735_inverted_color_unbuffered is an interface for the st7735 chip
    ...
    public:
         ...
         * @param reset
         */
        st7735_inverted_color_unbuffered_c(hwlib::spi_bus &bus, hwlib::pin_out &cs,
        ...
        void set_pixel(uint16_t x, uint16_t y, const uint16_t data) override {
            ...
            // write to ram
            st7735_inverted_color_unbuffered_c::write_command(st7735_inverted_color_unbuffered_c::_RAMWR);
        ...
        void set_pixels(uint16_t x, uint16_t y, uint16_t width, uint16_t height,
            ...
            st7735_inverted_color_unbuffered_c::set_cursor(x, y, x + width, y + height);
