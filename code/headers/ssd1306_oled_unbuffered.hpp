...
namespace r2d2::display {
    ...
    public:
        ...
        void clear(hwlib::color col) override {
            ...
            ssd1306_oled_unbuffered_c::command(ssd1306_oled_unbuffered_c::ssd1306_command::column_addr, 0, 127);
            ssd1306_oled_unbuffered_c::command(ssd1306_oled_unbuffered_c::ssd1306_command::page_addr, 0, 7);
